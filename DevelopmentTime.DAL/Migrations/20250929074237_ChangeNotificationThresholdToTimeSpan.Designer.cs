...
namespace DevelopmentTimer.DAL.Migrations
{
    ...
    [Migration("20250929074237_ChangeNotificationThresholdToTimeSpan")]
    partial class ChangeNotificationThresholdToTimeSpan
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevelopmentTimer.DAL.Entities.TaskItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = "InProgress",
                            Title = "Login Page",
                            TotalHours = new TimeSpan(0, 2, 0, 0, 0),
                            isApproved = false,
                            isReadonly = true
                        },
                        new
                        {
                            ...
                            Status = "Completed",
                            Title = "Register Page",
                            TotalHours = new TimeSpan(0, 3, 0, 0, 0),
                            isApproved = true,
                            isReadonly = true
                        },
                        new
                        ...
                        new
                        {
                            ...
                            Status = "InProgress",
                            Title = "Profile Page",
                            TotalHours = new TimeSpan(0, 4, 0, 0, 0),
                            isApproved = false,
                            isReadonly = true
                        });
                });
